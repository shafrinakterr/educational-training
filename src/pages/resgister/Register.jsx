                ...
                <div className="p-3  card flex-shrink-0 w-full lg:w-6/12 md:w-6/12 shadow-2xl bg-base-100">
                    ...
                    <form onSubmit={handleRegister} className="p-10 space-y-5">
                        ...
                        <div className="form-control mt-6">
                            <button className="btn text-lg mt-3 bg-[#063B29] text-white capitalize btn-outline">Register</button>
                            <p className="mt-5 text-center text-sm text-black font-medium">Already Have An Account ? <Link to='/login' className="text-[#063B29] font-bold">Login</Link></p>
                        </div><hr />
